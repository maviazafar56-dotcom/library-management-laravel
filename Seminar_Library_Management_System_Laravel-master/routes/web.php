...
Route::get('student/books','BookManageController@all_books_student');
Route::get('student/book-list/{category}','BookManageController@book_list_student');
Route::get('student/shelf/details/{id}','BookManageController@shelf_details_student');
Route::post('student/allocate-book/process','BookManageController@allocate_book_student');
...
Route::post('student/submit-book/{id}','StudentManageController@submit_book');
...
// Debug route to check shelf data
Route::get('/debug/shelves', function() {
    $shelves = DB::table('shelfs')->get();
    dd($shelves);
});

//admin
Route::get('/admin','AdminAuthController@sign_in_show');
Route::get('/admin/signup','AdminAuthController@sign_up_show');
Route::post('/admin/sign-up/process','AdminAuthController@sign_up_process');
...
Route::get('admin/books','BookManageController@all_books_admin');
Route::get('admin/book-list/{category}','BookManageController@book_list_admin');
...
Route::get('/mail-test', function() {
    \Mail::raw('Test email works!', function($m) {
        $m->to('badarnadeemkhan8@gmail.com')->subject('SMTP Test');
    });
    return 'Mail sent!';
});
